			...
			<div class="row">
				<div class="12u">
                    <section id="content">
                        <h2>EDIT ITEM</h2>
                        <br><br>
                        <?php echo form_open_multipart('csecure/editbarang/'.$barang->id); ?>
                        <table>
                        <tr class="nama">
                            <td width="100px"><label for="name">Name</label></td>
                            <td><?php echo form_input('nama', $barang->nama); ?></td>
                        </tr>
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                        <tr class="harga">
                            <td width="100px"><label for="harga">Price</label></td>
                            <td><?php echo form_input('harga',$barang->harga); ?></td>
                        </tr>
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                        <tr class="stock">
                            <td width="100px"><label for="stock">Stock</label></td>
                            <td><?php echo form_input('stok',$barang->stok); ?></td>
                        </tr>
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                        <tr class="discount">
                            <td width="100px"><label for="discount">Discount (%)</label></td>
                            <td><?php echo form_input('diskon',$barang->diskon); ?></td>
                        </tr>
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                        <tr class="category">
                        ...
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                        <tr class="image">
                            <td width="100px"><label for="image">Image/Picture</label></td>
                            <td>
								<?php 
									$gambar = array('src' => base_url().'system/barang/'.$barang->image);	
									echo img($gambar);			 
								?>
                            </td>
                        </tr>
                        ...
                        <tr class="submit">
                            <td>&nbsp;</td>
                            <td colspan="2"><?php echo form_submit('submit','CHANGE', 'id="submit"'); ?></td>
                        </tr>
                        </table>
                        <?php echo form_close(); ?>
                    </section>
